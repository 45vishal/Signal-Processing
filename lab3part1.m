...
y5=y4.*a2;
 ...
 ytx=y5+y12;    %transmission of both signals
%yrx=awgn(ytx,100);
%% detection of x2(n)
 %demod 
  a3=exp(-1i*n2*w2);
...
scatterplot(yrec32);
 ...
 subplot(311);
  plot(wT/pi,A);
 title('A1=1,A2=1 with Q=64');
 xlabel('Normalized frequency,\omegaT/pi');
ylabel('Amplitude spectrum');
 %stem(x1);
 subplot(312);
 
 plot(SIDR1); title('SIDR1');
 ylabel('SIDR in dB');
 xlabel('Values of S');
  subplot(313);
 plot(SIDR2);
